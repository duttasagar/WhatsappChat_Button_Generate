...
const Sidebar = ({ data, setData }) => {
  ...
  return (
    <div className="flex justify-center px-4 py-6 bg-gray-50 font-inter">
      <div className="w-full max-w-6xl bg-white rounded-xl flex flex-col overflow-hidden">
        {/* WhatsApp Button */}
        <div className="flex justify-center md:justify-start p-4 bg-gray-50">
          <a
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <h2 className="text-2xl text-gray-900 mb-4 font-bold text-center md:text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className="w-full p-2 mt-1 rounded-lg border border-gray-300 bg-white"
              />
              {errors.phone && (
